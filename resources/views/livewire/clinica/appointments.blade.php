...
new #[Layout('layouts.app')] class extends Component
{
    ...
    public function delete(): void
    {
        ...
        try {
            ...
            session()->flash('success', 'Agendamento excluído.');
...
<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-slate-800 dark:text-slate-100">Agendamentos</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Gestão de consultas e procedimentos.</p>
        </div>
        @can('create', \App\Models\Appointment::class)
            <button wire:click="openCreate" class="btn-primary flex items-center gap-2 px-4 py-2 text-sm">
                <x-heroicon-o-plus class="w-4 h-4" />Novo agendamento
            </button>
        @endcan
    </div>
    ...
    <div class="card mb-4 flex flex-wrap gap-3">
        <input wire:model.live.debounce.300ms="search" type="text" placeholder="Buscar paciente ou médico..." class="input flex-1 min-w-0" />
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60">
                    <th class="px-5 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Data/Hora</th>
                    ...
                    <th class="px-5 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Sala</th>
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700/60">
                ...
                @empty
                    <tr><td colspan="6" class="px-5 py-12 text-center text-sm text-slate-400">Nenhum agendamento encontrado.</td></tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            <div class="relative w-full max-w-lg bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 max-h-[90vh] flex flex-col">
                ...
                <div class="overflow-y-auto flex-1 p-6 space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Paciente</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Médico</label>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Data e hora</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Sala</label>
